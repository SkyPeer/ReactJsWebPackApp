...
function (_Component) {
  ...
  function Form() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onChangeInputFunc", function (event) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onClickButton", function () {
      _this.props.addTaskFunc(_this.state.inputValue);
    });
