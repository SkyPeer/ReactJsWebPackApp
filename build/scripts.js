...
function (_Component) {
  ...
  function MongoData(props) {
    var _this;

    _classCallCheck(this, MongoData);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(MongoData).call(this, props));
    _this.state = {
      mans: [{
        name: 'aaa'
      }, {
...
react_dom__WEBPACK_IMPORTED_MODULE_1___default.a.render(react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(MongoData, null), document.getElementById('mongoindex'));
